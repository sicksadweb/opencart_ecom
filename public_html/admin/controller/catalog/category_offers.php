...
class ControllerCatalogCategoryOffers extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$this->document->setTitle($this->language->get('heading_title_offers'));
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $category_id) {
				$this->model_catalog_category_offers->deleteCategory($category_id);
			}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title_offers'),
			'href' => $this->url->link('catalog/category_offers', 'user_token=' . $this->session->data['user_token'] . $url, true)
		);
		$data['add'] = $this->url->link('catalog/category_offers/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('catalog/category_offers/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['repair'] = $this->url->link('catalog/category_offers/repair', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['enabled'] = $this->url->link('catalog/category_offers/enable', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['disabled'] = $this->url->link('catalog/category_offers/disable', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$category_total = $this->model_catalog_category_offers->getTotalCategories();
		...
		$this->response->setOutput($this->load->view('catalog/category_offers_list', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['category_id'])) {
			$data['action'] = $this->url->link('catalog/category_offers/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/category_offers/edit', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $this->request->get['category_id'] . $url, true);
		}
		...
		if (isset($this->request->post['category_description'])) {
			...
			$data['category_description'] = $this->model_catalog_category_offers->getCategoryDescriptions($this->request->get['category_id']);
		} else {
		...
		if (isset($data['category_description'][$language_id]['name'])) {
			$data['heading_title_offers'] = $data['category_description'][$language_id]['name'];
		}
		...
		if (isset($this->request->post['category_filter'])) {
			...
			$filters = $this->model_catalog_category_offers->getCategoryFilters($this->request->get['category_id']);
		} else {
			$filters = array();
		}
		...
		if (isset($this->request->post['category_store'])) {
			...
			$data['category_store'] = $this->model_catalog_category_offers->getCategoryStores($this->request->get['category_id']);
		} else {
		...
		if (isset($this->request->post['product_related'])) {
			...
			$products = $this->model_catalog_category_offers->getProductRelated($this->request->get['category_id']);
		} else {
			$products = array();
		}	
		...
		if (isset($this->request->post['article_related'])) {
			...
			$articles = $this->model_catalog_category_offers->getArticleRelated($this->request->get['category_id']);
		} else {
			$articles = array();
		}			
		...
		if (isset($this->request->post['category_seo_url'])) {
			...
			$data['category_seo_url'] = $this->model_catalog_category_offers->getCategorySeoUrls($this->request->get['category_id']);
		} else {
		...
		if (isset($this->request->post['category_layout'])) {
			...
			$data['category_layout'] = $this->model_catalog_category_offers->getCategoryLayouts($this->request->get['category_id']);
		} else {
		...
		$this->response->setOutput($this->load->view('catalog/category_offers_form', $data));
	}
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name'])) {
			...
			$results = $this->model_catalog_category_offers->getCategories($filter_data);
	...
	private function getCategories($parent_id, $parent_path = '', $indent = '') {
		...
		static $href_action = null;
		if ($href_category === null) {
			$href_category = $this->url->link('catalog/category_offers', 'user_token=' . $this->session->data['user_token'] . '&path=', true);
			$href_action = $this->url->link('catalog/category/update', 'user_token=' . $this->session->data['user_token'] . '&category_id=', true);
		}
		$results = $this->model_catalog_category_offers->getCategoriesByParentId($parent_id);
		foreach ($results as $result) {
			...
			$output[$result['offers_id']] = array(
				'category_id' => $result['offers_id'],
				'name'        => $name,
				'sort_order'  => $result['sort_order'],
				'noindex'  	  => $result['noindex'],
				'edit'        => $this->url->link('catalog/category_offers/edit', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $result['offers_id'], true),
				'selected'    => $selected,
				'action'      => $action,
				'href'        => $href,
