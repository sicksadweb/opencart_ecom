...
class ControllerCatalogCategoryViews extends Controller {
	private $error = array();
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if (isset($this->request->post['dublicate'])) {

				$parent_views_id = $this->request->post['parent_id'];
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->model_catalog_category_views->editCategory($this->request->get['category_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $category_id) {
				$this->model_catalog_category_views->deleteCategory($category_id);
			}
	...
	protected function getList() {
		...
		$data['delete'] = $this->url->link('catalog/category_views/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['repair'] = $this->url->link('catalog/category_views/repair', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['enabled'] = $this->url->link('catalog/category_views/enable', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['disabled'] = $this->url->link('catalog/category_views/disable', 'user_token=' . $this->session->data['user_token'] . $url, true);		
		...
		$category_total = $this->model_catalog_category_views->getTotalCategories();
		...
		$this->response->setOutput($this->load->view('catalog/category_views_list', $data));
	}
	...
	protected function getForm() {
		...
		$data['is_edit'] = false;
		if ($this->request->get['route'] == 'catalog/category_views/edit') {
			$data['is_edit'] = true;
		}
		...
		if (!isset($this->request->get['category_id'])) {
			$data['action'] = $this->url->link('catalog/category_views/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/category_views/edit', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $this->request->get['category_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('catalog/category_views', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		if (isset($this->request->post['category_description'])) {
			...
			$data['category_description'] = $this->model_catalog_category_views->getCategoryDescriptions($this->request->get['category_id']);
		} else {
		...
		if (isset($this->request->post['path'])) {			
			...
			$data['offers_name'] = (!empty($category_info_offers)) ? $category_info_offers['name'] : '';			
			$data['offers_id'] = (!empty($category_info_offers)) ? $category_info_offers['offers_id'] : '';			
		} else {
			$data['path'] = '';
			$data['offers_name'] = '';
			$data['offers_id'] = '';
		...
		if (isset($this->request->post['category_filter'])) {
			...
			$filters = $this->model_catalog_category_views->getCategoryFilters($this->request->get['category_id']);
		} else {
			$filters = array();
		}
		...
		if (isset($this->request->post['category_store'])) {
			...
			$data['category_store'] = $this->model_catalog_category_views->getCategoryStores($this->request->get['category_id']);
		} else {
		...
		if (isset($this->request->post['product_related'])) {
			...
			$products = $this->model_catalog_category_views->getProductRelated($this->request->get['category_id']);
		} else {
			$products = array();
		}	
		...
		if (isset($this->request->post['article_related'])) {
			...
			$articles = $this->model_catalog_category_views->getArticleRelated($this->request->get['category_id']);
		} else {
			$articles = array();
		}			
		...
		if (isset($this->request->post['category_seo_url'])) {
			...
			$data['category_seo_url'] = $this->model_catalog_category_views->getCategorySeoUrls($this->request->get['category_id']);
		} else {
		...
		if (isset($this->request->post['category_layout'])) {
			...
			$data['category_layout'] = $this->model_catalog_category_views->getCategoryLayouts($this->request->get['category_id']);
		} else {
		...
		$this->response->setOutput($this->load->view('catalog/category_views_form', $data));
	}
	...
	protected function validateForm() {
		...
		if (isset($this->request->get['category_id']) && $this->request->post['parent_id']) {
			$results = $this->model_catalog_category_views->getCategoryPath($this->request->post['parent_id']);
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name'])) {
			...
			$results = $this->model_catalog_category_views->getCategories($filter_data);
	...
	private function getCategories($parent_id, $parent_path = '', $indent = '') {
		...
		static $href_action = null;
		if ($href_category === null) {
			$href_category = $this->url->link('catalog/category_views', 'user_token=' . $this->session->data['user_token'] . '&path=', true);
			$href_action = $this->url->link('catalog/category/update', 'user_token=' . $this->session->data['user_token'] . '&category_id=', true);
		}
		$results = $this->model_catalog_category_views->getCategoriesByParentId($parent_id);
		foreach ($results as $result) {
			...
			$output[$result['views_id']] = array(
				'category_id' => $result['views_id'],
				'name'        => $name,
				'sort_order'  => $result['sort_order'],
				'noindex'  	  => $result['noindex'],
				'edit'        => $this->url->link('catalog/category_views/edit', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $result['views_id'], true),
				'selected'    => $selected,
				'action'      => $action,
				'href'        => $href,
