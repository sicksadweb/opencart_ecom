...
class ControllerCatalogProductView extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $product_id) {
				$this->model_catalog_product->deleteView($product_id);
			}
	...
	protected function getList() {
		...
		*/
		...
		$data['copy'] = $this->url->link('catalog/product_view/copy', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('catalog/product_view/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['enabled'] = $this->url->link('catalog/product_view/enable', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['disabled'] = $this->url->link('catalog/product_view/disable', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['add_filter_for_product'] = $this->url->link('catalog/product_view/addFilterForProduct', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$product_total = $this->model_catalog_product->getTotalProductsView($filter_data);

		$results = $this->model_catalog_product->getProductsView($filter_data);
		...
		foreach ($results as $result) {
			...
			$product_specials = $this->model_catalog_product->getProductSpecials($result['view_id']);
			...
			$data['products'][] = array(
				...
				'href_shop'  => HTTP_CATALOG . 'index.php?route=product/product&product_id=' . $result['view_id'],
				'edit'       => $this->url->link('catalog/product_view/edit', 'user_token=' . $this->session->data['user_token'] . '&product_id=' . $result['view_id'] . $url, true)
			);
		}
		...
		$pagination->url = $this->url->link('catalog/product_view', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('catalog/product_view_list', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['product_id'])) {
			$data['action'] = $this->url->link('catalog/product_view/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/product_view/edit', 'user_token=' . $this->session->data['user_token'] . '&product_id=' . $this->request->get['product_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('catalog/product_view', 'user_token=' . $this->session->data['user_token'] . $url, true);

		if (isset($this->request->get['product_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$product_info = $this->model_catalog_product->getView($this->request->get['product_id']);
		...
		if (isset($this->request->post['product_description'])) {
			...
			$data['product_description'] = $this->model_catalog_product->getViewDescriptions($this->request->get['product_id']);
		} else {
		...
		if (isset($this->request->post['product_link'])) {
			...
			$product_links = $this->model_catalog_product->getProductsOfferLinks($this->request->get['product_id']);
		} else {
			$product_links = array();
		}
		...
		foreach ($product_links as $product_id) {
			$product_links_info = $this->model_catalog_product->getOfferDescriptions($product_id);
		...
		$this->response->setOutput($this->load->view('catalog/product_view_form', $data));
	}
