...
class ModelCatalogCategoryViews extends Model {
	...
	public function getCategoryPath($category_id) {
		$query = $this->db->query("SELECT views_id, path_id, level FROM " . DB_PREFIX . "category_views_path WHERE views_id = '" . (int)$category_id . "'");
