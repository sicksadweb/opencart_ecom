...
class ControllerAccountLogin extends Controller {
	...
	public function index() {
		...
		$redirect_uri = 'http://ecom/index.php?route=account/login'; // Callback URI
...
if (!empty( $tokenInfo['access_token'] )) {
	...
	$customer_info = $this->model_account_customer->getCustomerByTokenYandex( $tokenInfo['access_token'] );
