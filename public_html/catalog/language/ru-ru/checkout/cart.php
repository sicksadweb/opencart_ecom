...
// Heading
$_['heading_title']          = 'Корзина покупок/Оформление заказа';
$_['heading_title_cart']     = 'Корзина покупок';
$_['heading_title_checkout'] = 'Оформление заказа';
...
$_['text_checkout_account']                     = 'Шаг 1: Профиль &amp; Платежная информация';
